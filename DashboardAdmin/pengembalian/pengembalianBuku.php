...
<div class="p-4 mt-5">
  <div class="mt-5">
    <h2 class="text-center mb-4">List of Pengembalian</h2>
        ...
        <tbody>
          <?php foreach ($dataPeminjam as $item) : ?>
            <tr>
              ...
              <td>
                <div class="action">
                  <a href="deletePengembalian.php?id=<?= $item["id_pengembalian"]; ?>" class="btn btn-danger btn-delete" onclick="return confirm('Yakin ingin menghapus data?');">
