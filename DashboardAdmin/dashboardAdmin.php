...
<html lang="en">
  ...
  <body>
    ...
    <div class="mt-5 p-5">
      ...
      <div class="alert alert-success" role="alert">Selamat datang admin - <span class="fw-bold text-capitalize"><?php echo $_SESSION['admin']['nama_admin']; ?></span> di Dashboard Perpustakaan</div>
  ...
  <div class="cardImg">
    <a href="member/member.php">
      <img src="../assets/dashboardCardMember/member.png" alt="daftar buku" style="max-width: 100%; width: 400px;">
    </a>
  </div>
  <div class="cardImg">
    <a href="buku/daftarBuku.php">
      <img src="../assets/dashboardCardMember/bukuAdmin.png" alt="daftar buku" style="max-width: 100%; width: 400px;">
    </a>
  </div>
  <div class="cardImg">
  ...
  <div class="cardImg">
    <a href="pengembalian/pengembalianBuku.php">
      <img src="../assets/dashboardCardMember/pengembalianAdmin.png" alt="daftar buku" style="max-width: 100%; width: 400px;">
    </a>
  </div>
  <div class="cardImg">
